...
Revision ID: 0043_scheduled_tasks
...
revision: str = "0043_scheduled_tasks"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("schedule_type", sa.Enum("once", "daily", "weekly", name="scheduledtasktype"), nullable=False),
...
def downgrade() -> None:
    op.drop_index("ix_scheduled_tasks_workspace_active_next_run", table_name="scheduled_tasks")
    op.drop_index("ix_scheduled_tasks_user_active_next_run", table_name="scheduled_tasks")
