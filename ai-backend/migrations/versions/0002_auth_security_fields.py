...
def downgrade() -> None:
    op.drop_column("users", "is_2fa_enabled"); op.drop_column("users", "totp_secret"); op.drop_column("users", "locked_until"); op.drop_column("users", "failed_login_attempts"); op.drop_column("users", "is_email_verified")
