  ...
  ar: {
    translation: {
      ...
      modelCompare: {
        ...
        hint: "أرسل السؤال نفسه إلى نموذجين متاحين وشاهد الردين جنبًا إلى جنب.",
        promptPlaceholder: "اكتب السؤال للمقارنة...",
        modelA: "النموذج الأول",
        modelB: "النموذج الثاني",
        compare: "مقارنة",
        running: "جارٍ المقارنة...",
        needTwoModels: "تحتاج إلى نموذجين متاحين على الأقل لتفعيل المقارنة.",
        error: "تعذر تشغيل مقارنة النماذج.",
        cancel: "إلغاء",
      },
      publicAssistant: {
        backToApp: "الرجوع للتطبيق",
        loadError: "تعذر تحميل المساعد العام.",
        notFoundTitle: "المساعد غير موجود",
        noDescription: "لا يوجد وصف لهذا المساعد.",
        safeNotice: "هذا الرابط يعرض معلومات عامة فقط. تعليمات المساعد وملفات المعرفة الخاصة به لا تظهر هنا.",
        duplicate: "إضافة نسخة إلى حسابي",
        duplicating: "جارٍ إنشاء النسخة...",
        duplicateError: "تعذر إنشاء نسخة المساعد.",
        loginRequired: "سجّل الدخول أولًا ثم أعد المحاولة لنسخ المساعد إلى حسابك.",
      },

      publicAssistant: {
        backToApp: "Back to app",
        loadError: "Couldn't load the public assistant.",
        notFoundTitle: "Assistant not found",
        noDescription: "This assistant doesn't have a description.",
        safeNotice: "This page shows public information only. Private instructions and knowledge files are never exposed.",
        duplicate: "Add a copy to my account",
        duplicating: "Creating copy...",
        duplicateError: "Couldn't create the assistant copy.",
        loginRequired: "Sign in first, then try again to copy this assistant to your account.",
      },
      ...
      app: {
        ...
        folderReorderError: "تعذر إعادة ترتيب المجلدات",
        ...
        attachmentUploadErrorForFile: "تعذر رفع الملف {{name}}",
        attachmentRemoveError: "تعذر إزالة الملف المرفق",
        attachmentTooLarge: "تم تجاهل {{count}} ملف لأن الحجم يتجاوز 10 ميجابايت",
        attachmentsReady: "الملفات جاهزة للإرسال مع الرسالة",
      ...
      account: {
        ...
        sessionsSection: "جلسات تسجيل الدخول",
        sessionsDescription: "راجع الأجهزة والجلسات النشطة ويمكنك إلغاء أي جلسة لم تعد تستخدمها.",
        noSessions: "لا توجد جلسات نشطة",
        unknownDevice: "جهاز غير معروف",
        currentSession: "الجلسة الحالية",
        revokeSession: "إلغاء الجلسة",
        revokeAllSessions: "إلغاء كل الجلسات",
        sessionRevokeConfirm: "إلغاء هذه الجلسة؟",
        sessionRevokeAllConfirm: "إلغاء كل جلسات تسجيل الدخول؟ سيتم تسجيل خروجك من كل الأجهزة.",
        sessionRevoked: "تم إلغاء الجلسة",
        sessionsRevoked: "تم إلغاء كل الجلسات",
        sessionsLoadError: "تعذر تحميل جلسات تسجيل الدخول",
        dataExportSection: "تصدير بيانات الحساب",
        dataExportDescription: "نزّل نسخة JSON من بيانات حسابك الأساسية. لا يتم تضمين كلمات المرور أو مفاتيح API السرية أو رموز المصادقة.",
        exportData: "تصدير بياناتي",
        dataExported: "تم تجهيز ملف بياناتك للتنزيل",
      ...
      files: {
        ...
        close: "إغلاق",
        libraryCount: "{{count}} ملف",
        searchPlaceholder: "ابحث في الملفات...",
        noSearchResults: "لا توجد ملفات مطابقة",
        tryDifferentSearch: "جرّب اسمًا أو امتدادًا مختلفًا.",
        emptyHint: "ارفع ملفات PDF أو Word أو Excel أو صور لتستخدمها في المحادثة.",
        addMore: "إضافة ملفات",
        scopePersonal: "شخصي",
        scopeWorkspace: "مساحة عمل",
        scopeProject: "مشروع",
        attached: "مرفق",
        indexed: "مفهرس للذكاء الاصطناعي",
        ...
        uploadErrorForFile: "تعذر رفع الملف {{name}}",
      ...
      commandPalette: {
        ...
        hint: "يمكنك فتح لوحة الأوامر من أي مكان",
        actions: {
          newChat: "محادثة جديدة",
      ...
      sidebar: {
        ...
        changeFolderColorTitle: "تغيير لون المجلد",
        ...
        moveFolderUpTitle: "تحريك المجلد لأعلى",
        moveFolderDownTitle: "تحريك المجلد لأسفل",
      ...
      assistantEditor: {
        ...
        saving: "جارٍ الحفظ...",
        save: "حفظ",
        versionHistoryTitle: "سجل نسخ المساعد",
        versionHistorySubtitle: "استرجع أي نسخة سابقة دون حذف السجل.",
        ...
        compareTitle: "مقارنة الإصدار {{version}} مع النسخة الحالية",
        compareChanged: "هناك تغييرات بين النسختين.",
        compareUnchanged: "لا توجد تغييرات.",
        compareNoDiff: "لا يوجد فرق نصي.",
        compareError: "تعذر مقارنة النسختين.",
        closeCompare: "إغلاق المقارنة",
        analyticsTitle: "إحصائيات الاستخدام",
        analyticsSubtitle: "ملخص استخدام هذا المساعد خلال آخر 30 يومًا.",
        analyticsConversations: "المحادثات",
        analyticsMessages: "الرسائل",
        analyticsUsers: "المستخدمون النشطون",
        analyticsLastUsed: "آخر استخدام",
        analyticsNever: "لم يُستخدم بعد",
        ...
        rotatePublic: "تغيير الرابط",
        disablePublic: "إيقاف الرابط العام",
        rotatePublicConfirm: "تغيير الرابط سيبطل الرابط الحالي. متابعة؟",
        disablePublicConfirm: "إيقاف الرابط العام سيجعل الرابط الحالي غير صالح. متابعة؟",
        copyPublicPrompt: "انسخ الرابط:",
        knowledgeTitle: "ملفات المعرفة",
        knowledgeSubtitle: "أرفق ملفاتك الشخصية ليستخدمها هذا المساعد كمرجع دائم أثناء الإجابة.",
        knowledgeLoadError: "تعذر تحميل ملفات المعرفة.",
        uploadFile: "رفع ملف",
      ...
      assistantEditor: {
        ...
        versionHistorySubtitle: "Restore any previous version without deleting history.",
        ...
        compare: "Compare",
        comparing: "Comparing...",
        compareTitle: "Compare version {{version}} with current",
        compareChanged: "The versions are different.",
        compareUnchanged: "No changes.",
        compareNoDiff: "No text differences.",
        compareError: "Couldn't compare the versions.",
        closeCompare: "Close comparison",
        analyticsTitle: "Usage analytics",
        analyticsSubtitle: "Usage summary for this assistant over the last 30 days.",
        analyticsConversations: "Conversations",
        analyticsMessages: "Messages",
        analyticsUsers: "Active users",
        analyticsLastUsed: "Last used",
        analyticsNever: "Never used",
        analyticsUnavailable: "Couldn't load usage analytics",
        publicTitle: "الرابط العام",
        publicSubtitle: "شارك صفحة آمنة للمساعد ليتمكن الآخرون من رؤيته ونسخه إلى حساباتهم.",
        publicEnabled: "المساعد متاح عبر رابط عام.",
        enablePublic: "تفعيل الرابط العام",
        ...
        knowledgeLoadError: "Couldn’t load knowledge files.",
      ...
      tools: {
        ...
        activity: {
          ...
          agent: "وضع الوكيل",
          python: "بايثون",
          running: "جارٍ تشغيل {{tool}}...",
          done: "اكتملت {{tool}} ({{duration}}ms)",
          error: "تعذر تشغيل {{tool}}",
        },
  ...
  en: {
    translation: {
      ...
      modelCompare: {
        ...
        hint: "Send the same prompt to two available models and view the responses side by side.",
        promptPlaceholder: "Enter a prompt to compare...",
        modelA: "Model A",
        modelB: "Model B",
        compare: "Compare",
        running: "Comparing...",
        needTwoModels: "You need at least two available models to use comparison.",
        error: "Couldn't compare the models.",
        cancel: "Cancel",
      },
      ...
      app: {
        ...
        folderReorderError: "Couldn't reorder the folders",
      ...
      account: {
        ...
        sessionsSection: "Login sessions",
        sessionsDescription: "Review active devices and sign-in sessions, and revoke any session you no longer use.",
        noSessions: "No active sessions",
        unknownDevice: "Unknown device",
        currentSession: "Current session",
        revokeSession: "Revoke session",
        revokeAllSessions: "Revoke all sessions",
        sessionRevokeConfirm: "Revoke this session?",
        sessionRevokeAllConfirm: "Revoke all login sessions? You will be signed out on every device.",
        sessionRevoked: "Session revoked",
        sessionsRevoked: "All sessions revoked",
        sessionsLoadError: "Couldn't load login sessions",
        dataExportSection: "Export account data",
        dataExportDescription: "Download a JSON copy of your core account data. Passwords, API key secrets, and authentication tokens are not included.",
      ...
      files: {
        ...
        tryDifferentSearch: "Try a different file name or extension.",
        emptyHint: "Upload PDFs, Word, Excel files, or images to use them in chat.",
        addMore: "Add files",
        ...
        uploadErrorForFile: "Couldn't upload {{name}}",
      ...
      sidebar: {
        ...
        changeFolderColorTitle: "Change folder color",
        ...
        moveFolderUpTitle: "Move folder up",
        moveFolderDownTitle: "Move folder down",
      ...
      tools: {
        ...
        activity: {
          ...
          done: "{{tool}} completed ({{duration}}ms)",
          error: "{{tool}} failed",
        },
